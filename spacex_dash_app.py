...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        print('After == and before groupby')
        df1=filtered_df.groupby(['Launch Site','class'])['class'].size().reset_index(name='class count')
        print('Before pie chart statement')
...
def get_scatter_chart(entered_site, entered_payload):
    if entered_site == 'ALL':
        ...
        print('before scatter plot in else')
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
